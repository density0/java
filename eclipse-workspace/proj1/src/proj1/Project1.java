...
/**
 * <p>Kraft Mac & Cheese: Info </p>
 * <p>Description: This program tells you the how many ounces the product weighs  </p>
...
public class Project1 {
	public static void main(String[] args)
	{
		...
		*  Fixed it by taking away -1 and replacing 1 with 0. 
		*/
		prodBrand = prodInfo.substring(0, posOfSpace);
		
		/* starting on char 4, the type of product always comes after the brand name. 
		 * Fixed by taking away 4, replacing it with 1+posOfSpace
		 */
		prodType = prodInfo.substring(1+posOfSpace);
		...
		/* did'nt show the products weight value, added the var "numOunces" at the end of the quotations */
		System.out.println("Product Weight (in ounces): " + numOunces);
		
		/* var that was added wat prodPrice which tells the price of the item instead of price per Ounce, 
