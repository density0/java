...
public class Lab0App {
	...
	System.out.println("There are approximately " + numPeople + " people without power.");
	
	System.out.println("There are approximately " + numPets + " pets that need to be kept warm.");
	numShelters = numPeople + numPets / MAX_PEOPLE_PER_SHELTER + 1;
	System.out.println("The county needs to open " + numShelters + " emergency shelters for those without power.");
	
	numElectricians = numHouseholds / MAX_HOUSEHOLDS_PER_ELECTRICIAN;
	numExtra = numHouseholds % MAX_HOUSEHOLDS_PER_ELECTRICIAN;
	
	System.out.println(numElectricians + " electrician crews are needed to restore power to " + numExtra + " families. \nThere are " + numHouseholds + " households that will not be taken care of today.");
